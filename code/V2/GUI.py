...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(290, 30, 311, 401))
        ...
        self.tabWidget.setGeometry(QtCore.QRect(10, 10, 271, 261))
        ...
        self.list_1.setColumnStretch(1, 1)
        ...
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(10, 10, 241, 211))
        ...
        self.label_3.setGeometry(QtCore.QRect(30, 110, 261, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.tab)
        self.label_4.setGeometry(QtCore.QRect(40, 130, 191, 51))
        font = QtGui.QFont()
        ...
        self.labelC.setGeometry(QtCore.QRect(60, 170, 151, 21))
        self.labelC.setText("")
        self.labelC.setObjectName("labelC")
        self.pushButton_5 = QtWidgets.QPushButton(self.tab)
        self.pushButton_5.setGeometry(QtCore.QRect(90, 200, 75, 23))
        self.pushButton_5.setObjectName("pushButton_5")
        self.label_5 = QtWidgets.QLabel(self.tab)
        self.label_5.setGeometry(QtCore.QRect(80, 0, 81, 71))
        self.label_5.setText("")
        self.label_5.setPixmap(QtGui.QPixmap("icon.png"))
        self.label_5.setObjectName("label_5")
        self.tabWidget.addTab(self.tab, "")
        self.file = QtWidgets.QListWidget(self.centralwidget)
        self.file.setGeometry(QtCore.QRect(10, 280, 171, 151))
        self.file.setObjectName("file")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(210, 300, 121, 51))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.pushButton_2 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_2.setGeometry(QtCore.QRect(190, 350, 91, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_2.setFont(font)
        self.pushButton_2.setObjectName("pushButton_2")
        self.open_text = QtWidgets.QLabel(self.centralwidget)
        self.open_text.setGeometry(QtCore.QRect(180, 280, 101, 41))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.logoff.setGeometry(QtCore.QRect(190, 390, 91, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "1.3 (BUILD SAT 1105)"))
