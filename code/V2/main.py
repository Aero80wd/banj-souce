...
if __name__ == "__main__":
    ...
    MainWindow.setWindowTitle('BANJ-SOUCE V2 (Build SAT 1129) Login')
...
def num_1():
    try:
        ...
        messagebox.showerror('错误', '未打开文件' + Exception)
...
def banj_f():
    try:
        ...
        pj_nums = dict(sorted(pj_nums.items(), key=lambda d: d[1], reverse=False))
...
def banj_pm():
    try:
        ...
        banj_p = dict(sorted(banj_p.items(), key=lambda d: d[1], reverse=False))
